	...
	public defaults: any = {
		...
		aside: {
			...
			items: [
				 ...
				 {
					title: 'Applications', // <= Title of the page
					desc: 'Application shown as per the group', // <= Description of the page
					 root: true,
					 page: 'application-management', // <= URL
					 icon: 'flaticon-line-graph' // <= Choose the icon
				 },
				{
					title: 'Account Management', // <= Title of the page
					desc: 'Account Management information goes here', // <= Description of the page
					root: true,
					page: 'account-management', // <= URL
					icon: 'flaticon2-user' // <= Choose the icon
				},
