export class PageConfig {
	public defaults: any = {
		...
		'application-management': { // <= add page URL
			page: { title: 'Application', desc: 'Group of application' } // <= Page name and description
		},
		
		'account-management': { // <= add page URL
			page: { title: 'Account Management', desc: 'Account Management desc' } // <= Page name and description
		},
		ngbootstrap: {
			accordion: {
